...
public class HTTPSClientUtil {  
    ...
    public static String doPost(HttpClient httpClient, String url, Map<String, String> paramHeader,  
        ...
        return doPost(httpClient, url, paramHeader, jsonString, DEFAULT_CHARSET);  
    }  
  
    public static String doPost(HttpClient httpClient, String url, Map<String, String> paramHeader,  
            String jsonString, String charset) throws Exception {  
  
        String result = null;  
        HttpPost httpPost = new HttpPost(url);  
        setHeader(httpPost, paramHeader);  
        setBody(httpPost, jsonString, charset);  
    ...
    private static void setBody(HttpPost httpPost, String jsonString, String charset) throws Exception {  
        // 设置参数  
        if (jsonString != null) {  
